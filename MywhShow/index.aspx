...
<body class="site-home" id="LAY_home" style="background-color: #eee;">
    ...
    <div class="site-banner">
        ...
        <div class="site-banner-main">
            ...
            <div class="site-download">
                <a href="http://mywh.mywhblog.cn" class="layui-inline site-down" style="background-color:#01aaed;" target="_blank">
                    <cite class="layui-icon">&#xe623;</cite>
                    在线演示
                </a>
                <a href="javascript:void(0);" class="layui-inline site-down" target="_blank" onclick="test();">
                    <cite class="layui-icon">&#xe601;</cite>
                    立即下载
                </a>
            </div>
    ...
    <div class="layui-footer footer footer-index">
        <div class="layui-main">
            <p>© 2017 梦影雾花 - Mywh.Net框架&nbsp;&nbsp;<a href="http://www.miitbeian.gov.cn" target="_blank">豫ICP备17002472号-1</a>&nbsp;&nbsp;</p>
